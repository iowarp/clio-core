...
arms and `plot_fig9.py` draws them.

This file is the reference for the measurement. It lives beside the plotter
rather than under `figures/fig9/`, because that directory holds generated
output and is cleared whenever the figure is re-run.

# Shared setup for the Nyx paper benchmark. Sourced, not executed.
#
# The workload is a Sedov blast wave computed by Nyx (AMReX, CUDA, float32) and
# dumped to flat field files by gen_fields.sh. This phase replays those files
# through Clio with NeuroPress choosing a codec per chunk.
#

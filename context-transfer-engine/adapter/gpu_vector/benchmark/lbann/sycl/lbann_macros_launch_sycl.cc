...
#include "../lbann_macros_launch.h"

#include "../lbann_macros_kernels.h"
...
void LaunchFwd1(dim3 grid, dim3 block, const GpuInfo &info, DevF32 w,
  ...
  SubmitYieldable(grid, block, w, vw, sv,
                  [=](DevF32 dev, u32 blk_) {
                    ...
                    (void)bias0;
                    Fwd1Macro(dev, w1_off, b1v, I, H, B, x, a1, rbase + blk * hper,
...
void LaunchFwd2(dim3 grid, dim3 block, const GpuInfo &info, DevF32 w,
  ...
  SubmitYieldable(grid, block, w, vw, sv,
                  [=](DevF32 dev, u32 blk_) {
                    ...
                    const bool bias0 = (blk == 0);
                    (void)bias0;
                    Fwd2Macro(dev, w2_off, b2v, H, O, B, a1, y, d2, loss_parts, rbase + blk * oper,
...
void LaunchBwd1(dim3 grid, dim3 block, const GpuInfo &info, DevF32 w,
  ...
  SubmitYieldable(grid, block, w, vw, sv,
                  [=](DevF32 dev, u32 blk_) {
                    ...
                    const bool bias0 = (blk == 0);
                    (void)bias0;
                    Bwd1Macro(dev, w2_off, H, O, B, a1, d2, d1, rbase + blk * hper,
...
void LaunchUpd2(dim3 grid, dim3 block, const GpuInfo &info, DevF32 w,
  ...
  SubmitYieldable(grid, block, w, vw, sv,
                  [=](DevF32 dev, u32 blk_) {
                    ...
                    const bool bias0 = (blk == 0);
                    (void)bias0;
                    Upd2Macro(dev, w2_off, b2v, H, O, B, a1, d2, lr, rbase + blk * oper,
...
void LaunchUpd1(dim3 grid, dim3 block, const GpuInfo &info, DevF32 w,
  ...
  SubmitYieldable(grid, block, w, vw, sv,
                  [=](DevF32 dev, u32 blk_) {
                    ...
                    const bool bias0 = (blk == 0);
                    (void)bias0;
                    Upd1Macro(dev, w1_off, b1v, I, H, B, x, d1, lr, rbase + blk * hper,

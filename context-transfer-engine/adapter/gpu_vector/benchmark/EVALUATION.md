...
|---|---|---|---|---|---|
| kmeans, 1 iter over 8 GB/node | 2.02-2.18 s (3.7-4.0 GB/s), checksum 30720.000074 on all ranks, 7463-7472 faults and evicts, 0 puts | 3.97 s on all four nodes (2.0 GB/s), checksum 30719.999974, ~7456 faults and evicts; the DAOS tier file was its full 2.5 GB on every node, so the DAOS share carried a third of the faults at about half the DRAM-only rate | 5.58 s on all four nodes (1.43 GB/s), checksum 30719.999983, ~7450 faults and evicts; DAOS file 5.0 GB and Flare file 2.5 GB per node, both tiers at their full capacity, so only 0.5 GB stayed in DRAM | 5.21 s on three nodes and 4.44 s on the fourth (1.5-1.8 GB/s), checksum 30720.000022, ~7450 faults and evicts; DAOS file 7.0 GB per node (its full capacity), Flare file 2.0 GB on two nodes and 1.0 GB on the two others, the rest in DRAM: faster than the balanced mix because the DAOS share replaced Flare's | pending |

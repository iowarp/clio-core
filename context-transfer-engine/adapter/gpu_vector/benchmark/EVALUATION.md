...
| grayscott, 1 step over 8 GB/node | 3.18-3.50 s (18-20 GB/s of paged traffic), v_checksum 20286390.376762 on all ranks, 10521-10640 faults and evicts, 4096 puts (the step's write-back) | pending | pending | pending | pending |

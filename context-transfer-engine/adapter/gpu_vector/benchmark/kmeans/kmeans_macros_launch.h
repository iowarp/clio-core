...
/**
 * Launch seam for the MACRO-form kmeans paged bench.
 *
 * Identical signatures to kmeans_launch.h; the difference is entirely on the
 * device side, where suspension is expressed with yield_stack.h's macros
 * instead of C++20 coroutines. SPIR-V cannot compile a device coroutine, so
 * this is the spelling that reaches Intel GPUs.
 */
/**
 ...
 */
#ifndef CLIO_GV_BENCH_KMEANS_MACROS_LAUNCH_H_
#define CLIO_GV_BENCH_KMEANS_MACROS_LAUNCH_H_
...
#endif  // CLIO_GV_BENCH_KMEANS_MACROS_LAUNCH_H_

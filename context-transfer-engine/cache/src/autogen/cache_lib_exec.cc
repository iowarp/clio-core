/**
 * Container virtual API dispatch for the cache ChiMod (Run / Save / Load /
 * NewTask / Aggregate), switch-case over Method ids. Hand-maintained to
 * match clio_mod.yaml + cache_methods.h (mirrors the replication chimod's
...
// functions in sync.
#define CLIO_CACHE_FOR_EACH_METHOD(X)              \
...
#undef CLIO_CACHE_FOR_EACH_METHOD
